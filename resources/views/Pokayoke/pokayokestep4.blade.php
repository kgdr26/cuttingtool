...
<section>
    <div class="grid-flow">
                    ...
                    <div class="row w-100">
                        ...
                        <div class="col-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="op_name" value="" disabled>
                                </div>
                            </div>
                        </div>
        ...
        <div class="card-button">
            <div class="row">
                <div class="col-6">
                    <button id="step_3" class="btn btn-save w-100">PREVIOUS</button>
                </div>
                <div class="col-6">
                    <button id="step_5" class="btn btn-save w-100" disabled>NEXT</button>
                </div>
            </div>
        </div>
    </div>
    ...
    const getinstallmachine = () => {
        ...
        .then(data => {
            if(data.status) {
                ...
                document.getElementById('step_5').removeAttribute('disabled');
            }else {
                Swal.fire({
                    position:'center',
                    title: 'Failed!',
...
<script>
    document.getElementById('step_3').addEventListener('click', function() {
        ...
        let id_assy_old     = btoa('{!! $id_assy_old !!}');
...
{{-- next click --}}
<script>
    document.getElementById('step_5').addEventListener('click', function() {
        let id_list_machine = btoa('{!! $id_list_machine !!}');
        let id_assy_old     = btoa('{!! $id_assy_old !!}');
        ...
        window.location.href = "{{ route('pokayokestep5') }}" + '?id_list_machine=' + id_list_machine + '&id_assy_old=' + id_assy_old + '&id_assy_new=' + id_assy_new + '&tool_port=' + tool_port + '&status=' + status;
    });
</script>
