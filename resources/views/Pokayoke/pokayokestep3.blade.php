    ...
    <div class="grid-flow">
        ...
        <div class="card-button">
            <div class="row">
                ...
                <div class="col-6">
                    <button id="step_4" class="btn btn-save w-100">NEXT</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.getElementById('step_4').addEventListener('click', function() {
        var id_list_machine     = btoa('{!! $id_list_machine !!}');
        var id_assy_old         = btoa('{!! $id_assy_old !!}');
        var id_assy_new         = btoa($('#assy_id').val());
        var tool_port           = btoa($('#tool_port').val());

        window.location.href    = "{{route('pokayokestep4')}}" + '?id_list_machine=' + id_list_machine + '&id_assy_old=' + id_assy_old + '&id_assy_new=' + id_assy_new + '&tool_port=' + tool_port;
    });
</script>
