                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" id="machine_name" class="form-control" value="OP10 Turning Center" disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" id="op_name" class="form-control" value="10" disabled>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-costum">
                    ...
                    <input type="text" class="form-control" placeholder="" id="qr_code" readonly>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-save" id="check_machine_by_asset_id"><span>Scan</span></button>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.getElementById('next_step_2').addEventListener('click', function() {
        ...
        alert(id_list_machine);
        window.location.href = "{{route('tfirstpokayokestep2')}}" + '?id_list_machine=' + id_list_machine;
    });
</script>
