...
<section>
    <div class="grid-flow">
        <div class="card-step">
            <div class="header">
                <p>STEP 2  Scan New Tool</p>
                <p>Scan QRcode in New Tool</p>
            </div>
            <div class="body">
                    ...
                    <div class="row w-100">
                        <div class="col-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="assy_id" value="" disabled>
                                </div>
                            </div>
                        </div>
        ...
        <div class="card-button">
            <div class="row">
                <div class="col-6">
                    {{-- <a href="{{route('tfirstpokayokestep1')}}" class="btn btn-save w-100">PREVIOUS</a> --}}
                    <button id="step_1" class="btn btn-save w-100">PREVIOUS</button>
                </div>
                <div class="col-6">
                    {{-- <a href="{{route('tfirstpokayokestep3')}}" class="btn btn-save w-100">NEXT</a> --}}
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-save" id="check_trx_assy_by_qr"><span>Scan</span></button>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.getElementById('step_1').addEventListener('click', function() {
        ...
        window.location.href    = "{{route('tfirstpokayokestep1')}}" + '?id_list_machine=' + id_list_machine;
    });
</script>
...
<script>
    document.getElementById('step_3').addEventListener('click', function() {
        var id_list_machine     = btoa('{!! $id_list_machine !!}');
        var id_assy_new         = btoa($('#assy_id').val());
        var tool_port           = btoa($('#tool_port').val());

        window.location.href    = "{{route('tfirstpokayokestep3')}}" + '?id_list_machine=' + id_list_machine + '&id_assy_new=' + id_assy_new + '&tool_port=' + tool_port;
    });
</script>
